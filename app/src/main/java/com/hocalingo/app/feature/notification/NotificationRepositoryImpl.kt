...
class NotificationRepositoryImpl @Inject constructor(
    ...
    override suspend fun getWordForNotification(): Result<WordSummary?> =
    ...
    override suspend fun recordNotificationSent(wordId: Int): Result<Unit> =
        withContext(Dispatchers.IO) {
            try {
    ...
    private suspend fun getOverdueWordForNotification(): WordSummary? {
        return try {
            ...
            val dbDirection = when (studyDirection) {
                StudyDirection.EN_TO_TR -> com.hocalingo.app.database.entities.StudyDirection.EN_TO_TR
                StudyDirection.TR_TO_EN -> com.hocalingo.app.database.entities.StudyDirection.TR_TO_EN
                StudyDirection.MIXED -> com.hocalingo.app.database.entities.StudyDirection.EN_TO_TR // Default fallback for mixed
            }
