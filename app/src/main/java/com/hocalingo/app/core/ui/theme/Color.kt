...
val Tertiary = Color(0xFFFF9800)          // Orange - Motivation & Energy
val OnTertiary = Color(0xFFFFFFFF)
val TertiaryContainer = Color(0xFFFFF3E0)
val OnTertiaryContainer = Color(0xFFE65100)

val Error = Color(0xFFD32F2F)             // Red - Difficulty & Errors
...
// Custom HocaLingo Colors
object HocaColors {
    val EasyGreen = Color(0xFF4CAF50)      // Kolay buton
    val MediumYellow = Color(0xFFFF9800)   // Orta buton
    val HardRed = Color(0xFFE53935)        // Zor buton

    val StreakFire = Color(0xFFFF5722)     // Streak indicator
    val MasteredGold = Color(0xFFFFD700)   // Mastered words

    val CardShadow = Color(0x1A000000)     // Card shadows
    val DividerGray = Color(0xFFE0E0E0)    // Dividers
}